...
reference compression formulas. The GLM-5.3 support branch additionally fixes
packed-request prefill tail persistence and graph metadata buffer lifetimes,
separates CUDA/PPU dispatch and cache dtypes, and removes diagnostic skip-write
switches. These changes are described in `examples/glm5_next/README.md` and
covered by the GLM component tests; this is not an unchanged source copy.
