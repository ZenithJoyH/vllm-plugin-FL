...
def qsa_select_paged_tokens(
    ...
    for row_start in range(0, rows, rows_per_chunk):
        ...
        # Sorting keeps visible blocks before -inf padding. Primitive TopK
        # follows the existing FlagGems/PyTorch operator registration.
        _, blocks = torch.topk(logits, block_topk, dim=-1, largest=True, sorted=True)
        del visible_blocks
