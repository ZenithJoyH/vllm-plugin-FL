...
"""Install Qwen3.5/Qwen3.8 text-only compatibility at vLLM runtime.

This is the plugin-owned equivalent of the vLLM source patches from
PRs #36607/#36850 plus the private Qwen3.8 text-RoPE cleanup.  No files in the
vLLM installation are modified.
"""
...
def apply_qwen3_5_v024_patches() -> bool:
    """Register the runtime shims for Qwen3.5/Qwen3.8 text-only models.
