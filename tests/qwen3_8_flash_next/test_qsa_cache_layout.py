...
from vllm_fl.models.qwen3_8_flash_next import (
    QSAStateBackend,
...
def test_qsa_backends_use_num_blocks_first_stride_layout(
    backend, expected_order, expected_layered_order
):
    # Both cache shapes are num-blocks-first and all QSA kernels consume the
    # physical block stride, so padded hybrid-cache pages are supported.
